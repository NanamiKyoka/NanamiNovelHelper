...
describe('ErrorCode', () => {
  it('should have all expected error codes', () => {
    ...
    expect(ErrorCode.PROJECT_ALREADY_EXISTS).toBe('PROJECT_ALREADY_EXISTS')
    ...
    expect(ErrorCode.DATA_LOAD_ERROR).toBe('DATA_LOAD_ERROR')
    expect(ErrorCode.DATA_SAVE_ERROR).toBe('DATA_SAVE_ERROR')
