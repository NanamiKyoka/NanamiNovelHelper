...
export function MapCanvas({ onSave }: MapCanvasProps) {
  ...
  // 渲染所有板块
  const renderRegions = useCallback((data: MapData) => {
  ...
  }, [selectedRegionId, tool, connectingFromId, selectRegion, startConnecting, finishConnecting, deleteRegion, moveRegion, renderRegion])
  ...
  }, [currentMap, selectedRegionId, renderGrid, renderRegions, renderConnections, renderAnnotations, renderDrawing])
